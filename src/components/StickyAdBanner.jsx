...
// Dismissed for 4 hours via localStorage so it reappears on return visits.

const DISMISS_KEY = 'cw_sticky_dismissed'
...
export default function StickyAdBanner() {
  ...
  useEffect(() => {
    ...
    if (!t || Date.now() - Number(t) > DISMISS_TTL) setDismissed(false)
  }, [])
